function zentryScroll() {
  let stickySection = document.querySelector(".u-image-text"),
    totalStickyHeight = window.innerHeight * stickySection.querySelectorAll(".card").length,
    cards = gsap.utils.toArray(".u-image-text .card:not(:first-of-type)"),
    textElements = gsap.utils.toArray(".u-image-text__note .-desk p");
